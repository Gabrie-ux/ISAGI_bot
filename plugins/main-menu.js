...
let handler = async (m, { conn, usedPrefix }) => {
  ...
  let infoUser = `
> ʜᴏʟᴀ, ${nombre}, ꜱᴏʏ ɴᴀɢɪ-ʙᴏᴛ, ʟɪꜱᴛᴏ ᴘᴀʀᴀ ᴀʏᴜᴅᴀʀᴛᴇ
...
*乂 ɪɴꜰᴏ ᴅᴇʟ ʙᴏᴛ*
ꕥ ɢʀᴜᴘᴏꜱ: ${groupsCount}
ꕥ ᴛɪᴇᴍᴘᴏ ᴀᴄᴛɪᴠᴏ: ${muptime}
ꕥ ᴜsᴜᴀʀɪᴏs: ${totalreg}
ꕥ ᴘʟᴀᴛᴀꜰᴏʀᴍᴀ: ʟɪɴᴜx
...
`.trim()
  ...
  // 🎴 Imagen portada
  let imagen = 'https://cdn.yupra.my.id/yp/ks03er7o.jpg'
